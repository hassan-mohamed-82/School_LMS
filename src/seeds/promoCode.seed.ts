import PromoCode from '../models/schema/superadmin/promocode';
...
export const seedPromoCodes = async ({ superAdminId, planIds }: SeedParams) => {
    ...
    const promoCodes = await PromoCode.insertMany(promoCodeSeeds);

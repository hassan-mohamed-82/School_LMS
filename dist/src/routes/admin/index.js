...
const schoolAdminRoles_1 = __importDefault(require("./schoolAdminRoles"));
const schoolAdmin_1 = __importDefault(require("./schoolAdmin"));
...
router.use("/schooladmin", schoolAdmin_1.default);
router.use("/schooladminroles", schoolAdminRoles_1.default);

...
exports.seedSubscriptionPlans = exports.subscriptionPlanSeeds = void 0;
const plans_1 = __importDefault(require("../models/schema/superadmin/plans"));
exports.subscriptionPlanSeeds = [
    {
...
const seedSubscriptionPlans = async () => {
    ...
    const plans = await plans_1.default.insertMany(exports.subscriptionPlanSeeds);
